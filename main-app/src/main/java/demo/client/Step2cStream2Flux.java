...
public class Step2cStream2Flux {

	private static final Logger logger = LoggerFactory.getLogger(Step2cStream2Flux.class);
	...
	public static void main(String[] args) {
		...
		Flux.range(1, 3)
						...
						.flatMap(i -> client
										.get().uri("/person/{id}", i)
										.retrieve().bodyToMono(Person.class)) //subscribe to mono, nested call
