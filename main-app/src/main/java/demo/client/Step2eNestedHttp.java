...
public class Step2eNestedHttp {

	private static final Logger logger = LoggerFactory.getLogger(Step2eNestedHttp.class);
	...
	public static void main(String[] args) {
		...
		// Inter-dependant, nested calls
		// Concise, readable and concurrent
		Flux.range(1, 3)
